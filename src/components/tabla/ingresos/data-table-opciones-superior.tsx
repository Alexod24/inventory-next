...
import { RegistrarIngresoModal } from "@/components/RegistrarIngresoModal"; // Ajusta la ruta si es necesario
  ...
  return (
    <div className="flex space-x-2 ml-auto">
      ...
      <RegistrarIngresoModal
        isOpen={isOpen}
        onClose={closeModal}
        onIngresoCreated={fetchData} // <-- CORREGIDO: Usamos el nombre correcto
      />
    </div>
  );
}
