...
//   } = useModal(); // Modal para agregar categoría
...
//       fecha_v: form.fecha_v
//         ? new Date(form.fecha_v).toISOString().split("T")[0]
//         : null,
...
//                 </td>
//                 <td className="py-3 px-4 text-gray-500 text-sm dark:text-gray-400 text-center align-middle">
//                   {producto.stock}
//                 </td>
...
//               Llena los datos para {productoSeleccionado ? "editar" : "agregar"}{" "}
//               un producto
//             </p>
//           </div>
...
//                     value={form.fecha_c}
//                     onChange={(e) =>
//                       setForm({ ...form, fecha_c: e.target.value })
//                     }
