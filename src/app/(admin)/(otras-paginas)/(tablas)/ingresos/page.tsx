...
import { DataTable as ExpenseTable } from "@/components/tabla/ingresos/data-table";
import { columns as expenseColumns } from "@/components/tabla/ingresos/columns";
  ...
  return (
    <div className="container mx-auto py-4 space-y-4 overflow-x-hidden">
      ...
      <div className="overflow-x-auto max-w-full">
        <h2 className="text-xl font-semibold mb-4">Registro de Ingresos</h2>
        <ExpenseTable
          data={expenseData}
