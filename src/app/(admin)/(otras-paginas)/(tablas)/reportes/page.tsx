...
import { DataTable as ExpenseTable } from "@/components/tabla/reportes/data-table";
import { columns as expenseColumns } from "@/components/tabla/reportes/columns";
  ...
  return (
    <div className="container mx-auto py-4 space-y-4 overflow-x-hidden">
      ...
      <div className="w-full">
        <Imagen
          src="/images/espacios/reportes.jpg"
      ...
      <div className="overflow-x-auto max-w-full">
        <h2 className="text-xl font-semibold mb-4">Lista de Documentos</h2>
        <ExpenseTable
          data={expenseData}
