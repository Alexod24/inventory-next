  ...
  const handleSubmit = async(e) => {
    ...
    try {
      const { data, error } = await supabase.auth.signInWithOtp({
        email,
        options: {
          shouldCreateUser: true, // Cambia a true si quieres que se cree un usuario automáticamente.
        },
      });
        ...
        <div className="flex min-h-full flex-1">
          <div className="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
            <div className="mx-auto w-full max-w-sm lg:w-96">
              <div>
              <img src="/assets/images/logo.png" alt="La Base" className="h-10 w-auto" />
                <h2 className="mt-8 text-2xl/9 font-bold tracking-tight text-gray-900">Inicia Sesion con tu cuenta</h2>
                <p className="mt-2 text-sm/6 text-gray-500">
                  Not a member?{' '}
                  <a href="/register" className="font-semibold text-amber-500 hover:text-amber-400">
                    Registrate aquí
                  </a>
                </p>
              </div>
